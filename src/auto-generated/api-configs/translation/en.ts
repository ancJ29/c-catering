export default {
  ...
  "Note 1": "Note 1",
  "Note 2": "Note 2",
  "Supplier rejected PO": "Supplier rejected PO",
  "all suppliers": "all suppliers",
  "all caterings": "all caterings",
  "PO with status": "PO with status",
  "not included in this function": "not included in this function",
  "When exporting": "When exporting",
  "or": "or",
  "system needs more time to calculate": "system needs more time to calculate",
