export default {
  ...
  "Please check all the amounts of materials":
    "Vui lòng kiểm tra toàn bộ số lượng các loại nguyên liệu",
  "Export List": "Danh sách phiếu xuất",
  "Warehouse receipt date": "Ngày giao",
  "Released from warehouse": "Xuất tại kho",
  "Warehouse transfer": "Xuất chuyển kho",
  "Warehouse receipt case": "Trường hợp",
  "Export Inventory": "Xuất kho",
  "Manual export": "Xuất thủ công",
  "Quantitative export": "Xuất theo định lượng",
  "Export on demand": "Xuất chuyển theo yêu cầu",
  "Export receipt": "Phiếu xuất",
  "Daily": "Hằng ngày",
  "Material order cycle": "Chu kỳ đặt hàng",
  "Add to export receipt": "Thêm vào phiếu xuất",
  ...
  "Save and email to supplier successfully":
    "Lưu và gửi mail tới nhà cung cấp thành công",
  "Shift services": "Ca phục vụ",
  "Meal count": "Số phần ăn",
  "Revenue": "Doanh thu",
  "Daily task": "Công việc hằng ngày",
  "Daily data": "Số liệu trong ngày",
  "View": "Xem",
  "Supplier orders": "Đơn hàng từ nhà cung cấp",
  "Internal orders to complete": "Đơn hàng luân chuyển nội bộ cần hoàn tất",
  "Warehouse usage output": "Xuất kho sử dụng",
  "Order production materials": "Đặt nguyên liệu sản xuất",
  "Update meal plans": "Cập nhật suất ăn",
  "Update meal plan description":
    "Hàng ngày bạn nên cập nhật suất ăn thực tế để giúp quản lý kiểm soát công nợ nhanh chóng",
  "Today, there are": "Hôm nay, có",
  "PO order(s) to import": "đơn hàng PO cần nhập",
  "transfer order(s) to import": "phiếu chuyển kho cần nhập",
  ...
  "Update catering": "Cập nhật bếp",
  "Are you sure you want to update catering?":
    "Bạn có chắc chắn muốn cập nhật bếp?",
  "User": "Người dùng",
  "Enable catering": "Bếp hoạt động",
  "Customers to be served": "Khách hàng cần phục vụ",
  "Pending confirmation": "Yêu cầu cần xác nhận",
  "Dispatch case": "Trường hợp điều phối",
  "Purchase case": "Trường hợp mua hàng",
  "PO to be processed": "PO cần xử lý",
  "Catering has not ordered": "Bếp chưa đặt hàng",
  "Catering has ordered for tomorrow": "Bếp đã đặt hàng cho ngày mai",
  "Catering has not stocked": "Bếp chưa nhập kho",
  ...
  "Note 1": "Lưu ý 1",
  "Note 2": "Lưu ý 2",
  "Supplier rejected PO": "NCC từ chối PO",
  "all suppliers": "tất cả nhà cung cấp",
  "all caterings": "tất cả bếp",
  "PO with status": "Những PO có trạng thái",
  "not included in this function": "không được tính trong chức năng này",
  "When exporting": "Khi tùy chọn xuất",
  "or": "hoặc",
  "system needs more time to calculate":
    "hệ thống cần nhiều thời gian hơn để tính toán",
